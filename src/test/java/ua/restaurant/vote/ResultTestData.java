...
public class ResultTestData {
    ...
    public static final ResultTo RESULT_TO1 = new ResultTo(100004, RestaurantTestData.RESTAURANT1.getName(), 1L);
    public static final ResultTo RESULT_TO2 = new ResultTo(100005, RestaurantTestData.RESTAURANT2.getName(), 1L);
    public static final ResultTo RESULT_TO3 = new ResultTo(100006, RestaurantTestData.RESTAURANT3.getName(), 2L);
